...
import { ChevronLeft, Save, UserCircle, Shield, Lock, LogOut } from "lucide-react"
...
const Profile = ({ setCurrentUser, onLogOut }) => {
  ...
  const [passwords, setPasswords] = useState({ current: "", new: "", confirm: "" }) // ✅ password state
  ...
  const changePassword = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        ...
        { currentPassword: passwords.current, newPassword: passwords.new }, // ✅ fixed field name
        { headers: { Authorization: `Bearer ${token}` } }
      )
      if (data.success) {
