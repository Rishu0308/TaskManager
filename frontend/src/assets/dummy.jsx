...
export const SIDEBAR_CLASSES = {
    ...
    mobileButton: "absolute md:hidden top-25 left-5 z-40 bg-purple-600 text-white p-2 rounded-full shadow-lg hover:bg-purple-700 transition",
...
export const TABS_WRAPPER = "hidden md:flex space-x-1 bg-purple-50 p-1 rounded-lg gap-4 px-4"
export const TAB_BASE = "px-3 py-1.5 rounded-lg text-xs font-medium transition-all"
export const TAB_ACTIVE = "bg-white text-purple-700 shadow-sm border rounded-lg px-4 py-0.5"
