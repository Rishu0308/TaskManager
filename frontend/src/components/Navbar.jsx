...
const Navbar = ({ user, onLogout }) => {
  ...
  return (
    <header className='container w-full sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm
      ...
      <div className=' flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto '>
        ...
        >
          ...
          via-purple-500 to-indigo-500 bg-clip-text text-transparent tracking-wide'>
            TaskFlow
          </span>
        </div>
        {/* Right Side*/}
              ...
              <div className='relative flex gap-2 items-center'>
                {user?.avatar ? (
                  <div className='relative'>
                    ...
                    <div className='absolute -bottom-1 w-3 h-3 bg-green-400 rounded-full border-2 border-white animate-pulse right-0'>
                    </div>
                  </div>
                ) : (
                  <div className=' w-8 h-8 flex items-center justify-center rounded-full
                  bg-gradient-to-br from-fuchisa-500 to-purple-600 text-white font-semibold shadow-md'>
              ...
              shadow-xl border border-purple-100 z-50 overflow-hidden animate-fadeIn'>
                <li className=' p-2'>
                  <button onClick={() => {
                    ...
                    className=' w-full px-4 py-2.5 text-left hover:bg-purple-50 text-sm cursor-pointer
