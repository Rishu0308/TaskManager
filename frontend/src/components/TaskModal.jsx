...
import { AlignLeft, PlusCircle, Save, X, Flag, Calendar, CheckCircle } from 'lucide-react'
...
export const TaskModal = ({ isOpen, onClose, taskToEdit, onSave, onLogout }) => {
  ...
  return (
    <div className='fixed inset-0 backdrop-blur-sm bg-black/20 z-50 flex items-center justify-center p-4'>
      <div className='bg-white border border-purple-100 rounded-xl w-md shadow-lg relative p-6 animate-fadeIn'>
        ...
        <form onSubmit={handleSubmit} className=' space-y-4'>
          ...
          <div>
            ...
            <div className=' flex gap-4'>
              {[{ val: 'Yes', label: 'Complete' }, { val: 'No', label: 'In Progress' }].map(
                ({ val, label }) => (
          ...
          {/* Submit */}
            <button
              type='submit' disabled={loading} className='w-full bg-gradient-to-r from-fuchsia-500 to-purple-600 text-white
